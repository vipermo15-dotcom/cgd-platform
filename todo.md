...
## PDF 분석 메모
- [개인정보 삭제됨 — 2026-08-07] 이 섹션에는 샘플 재학생 1명의 실명·생년월일·주소·전화번호·이메일이 포함되어 있었습니다.
  공개 저장소에 노출되어 있던 것을 확인하고 삭제했습니다. 원본 이력서/포트폴리오 PDF와 상세 메모는
  저장소가 아닌 비공개 채널(관리자 로컬 파일 등)에서만 보관하세요.
- 참고용 요약(개인 식별 정보 제외): 만화/캐릭터 굿즈 디자인 전공, 일본 유학 경험, Photoshop/Illustrator/InDesign/Lightroom 사용,
  프로젝트 구성은 축제 굿즈·오리지널 캐릭터 굿즈·북커버 리디자인 등으로 구성.
